...
data class Resource<T>(
    ...
    /**
     * Метод для выполнения части [block] если текущее состояние равно [INTERNET_ERROR].
     *
     * @param block - блок для выполнения.
     * @return текущий ресурс.
     */
    fun ifInternetError(block: (data: T?) -> Unit): Resource<T> {
    ...
    companion object {
         ...
         * Нет интернета.
         */
        fun <T> internetError(data: T? = null): Resource<T> =
            Resource(
    ...
    enum class Status {
        ...
        /**
         * Проверка на состояние [INTERNET_ERROR].
         *
         * @return true если текущее состояние равно [INTERNET_ERROR], в противном случае false.
         */
        fun isInternetError(): Boolean = this == INTERNET_ERROR
